...
const BuildMuscle = () => {
  ...
  const workouts = [
    { name: 'Squats', time: 30 },
    { name: 'Bench Press', time: 30 },
    { name: 'Deadlifts', time: 30 },
    { name: 'Pull-ups', time: 30 },
    { name: 'Military Press', time: 30 },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerBox}>
        <Text style={styles.headerText}>Build Muscle</Text>
        <View style={styles.innerBox}>
          <Text style={styles.subHeaderText}>5 Workouts, 2 Minutes</Text>
        </View>
        <Text style={styles.extraText}>
          Gain muscle and strength with these powerful and effective workouts.
        </Text>
      </View>
